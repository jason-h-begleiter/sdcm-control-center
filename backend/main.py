...
def read_json(file_path):
    """Safely reads and parses a JSON file into a Python dictionary."""
    try:
...
def get_full_state():
    """Reads the ECS graph state generated by ecs_reporter.py."""
    # We map graph_state.json to "project_state" so App.jsx reads it seamlessly
    return {
